...
class ServiceBanner extends Controller {

    public function create(){

        $dataArray = input('post.');

        $houseM = ServiceBannerService::create($dataArray);
    ...
    public function edit(){
        ...
        $houseM = ServiceBannerService::edit($dataArray);
    ...
    public function detail()
    {
        ...
        $list = ServiceBannerService::getDetailById($params['id']);
    ...
    public function uploadAlbum(){
       ...
       $data =  ImgService::upload('serviceBanner');
    ...
    public function queryList(){
        ...
        $list = ServiceBannerService::queryList([], $params['page'], $params['pageSize']);
    ...
    public function queryServiceList(){
        ...
        $list = ServiceBannerService::queryServiceList();
