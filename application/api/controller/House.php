...
//                echo $file->getError();
    ...
    public function changeStatus()
    {
        ...
        $houseM = HouseService::changeStatus($dataArray);
    ...
    public function publicityHouseList()
    {
        ...
        // TO DO 默认云姐，后续更新小程序后返回控制判断
        $p_where =[
            'id'=>$params['id']
        ] ;

        $publicity = PublicityService::find($p_where);
    ...
    public function publicityHouseEditList()
    {
        $request = Request::instance();
        $params = $request->param();
        ...
        $data = HouseService::queryPublicityEditHouse($where, $params['page'], $params['pageSize']);
